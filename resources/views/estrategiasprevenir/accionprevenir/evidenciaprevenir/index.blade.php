...
<x-app-layout>
    <x-slot name="header">
        ...
        @endif
        @if(isset($accionPrevenir))
            <p class="font-semibold text-sm text-gray-800 leading-tight text-center">
                Acción de Prevención: {{ $accionPrevenir->accion }}
            </p>
        @endif
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">                  
                    <div class="mb-4">
                        <a href="{{ route('estrategiasprevenir.accionprevenir.index', ['estrategia' => $estrategia->id]) }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150">
                            Regresar a  las Acciones de Prevención
                        </a>
                    </div>
