    ...
    <x-app-layout>
        <x-slot name="header">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">
                EDITAR ACCIÓN DE PREVENCIÓN EN ESTRATEGIA
            </h2>
        </x-slot>
        <div class="py-12">
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form method="POST" action="{{ route('estrategiasprevenir.accionprevenir.update', ['estrategiaId' => $estrategia->id, 'accionPrevenirId' => $accionPrevenir->id]) }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="accion" id="accion" class="mt-1 p-2 block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" value="{{ $accionPrevenir->accion }}">
                            </div>
