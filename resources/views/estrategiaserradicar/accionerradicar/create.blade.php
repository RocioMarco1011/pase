    ...
    <x-app-layout>
        <x-slot name="header">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">
                CREAR NUEVA ACCIÓN DE ERRADICACIÓN
            </h2>
        </x-slot>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form method="POST" action="{{ route('estrategiaserradicar.accionerradicar.store', ['estrategia' => $estrategia->id]) }}">
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <select name="dependencias_responsables[]" id="dependencias_responsables" class="js-example-basic-multiple" multiple="multiple">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="dependencias_coordinadoras[]" id="dependencias_coordinadoras" class="js-example-basic-multiple" multiple="multiple">
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}">{{ $user->name }}</option>
                                    @endforeach
                                </select>
