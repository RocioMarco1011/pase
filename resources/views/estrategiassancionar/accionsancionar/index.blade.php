            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table class="min-w-full border-collapse border-2 border-gray-300">
                        ...
                        <tbody>
                            @foreach($accionesSancionar as $accion)
                            <tr>
                                ...
                                <td class="py-2 px-4 text-lg border-b border-r text-center">
                                    <a href="{{ route('estrategiassancionar.accionsancionar.show', ['estrategia' => $estrategia->id, 'accion' => $accion->id]) }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150">
                                        Ver
                                    </a>                                                                                             
                                </td>
                                @endcan
                                <td class="py-2 px-4 text-lg border-b border-r text-center">
                                    <a href="{{ route('evidenciasancionar.index', ['estrategiaId' => $estrategia->id, 'accionSancionarId' => $accion->id]) }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150">
                                        Evidencias
                                    </a> 
                                </td>
                            </tr>
