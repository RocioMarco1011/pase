            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <!-- Mostrar información del indicadorerradicar -->
                        <h2 style="font-size: 20px;"><strong>VARIABLES:</strong> {{ $indicadorerradicar->variables }}</h2>
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">
                            &nbsp;
                        </h2>
                        <!-- Formulario para calcular nuevo resultado -->
                        <form action="{{ route('indicadoreserradicar.calcularerradicar.guardarNuevoCalculo', ['indicadorerradicar' => $indicadorerradicar->id]) }}" method="post">
                            @csrf
