...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">
            CREAR INDICADOR DE ERRADICACIÓN
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('indicadoreserradicar.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            <label for="semaforo" class="block text-sm font-medium text-gray-700">Semáforo</label>
                            <select name="semaforo" id="semaforo" class="mt-1 p-2 w-full border rounded-md">
                                <option value="Verde > 0 - Amarillo = 0 - Rojo < 0">Verde > 0 - Amarillo = 0 - Rojo < 0</option>
                                <option value="Verde < 0 - Amarillo = 0 - Rojo > 0">Verde < 0 - Amarillo = 0 - Rojo > 0</option>
                            </select>
                        </div>
